...
When running simulation studies, it is often preferable to save results to file so they can be loaded and modified at a later time. You may save results to file by specifying arguments for the paths to use, as follows:
