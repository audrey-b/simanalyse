...
Analyse the 5 datasets in "report" mode. This mode runs iterations until convergence, based on r.hat < 1.1 and an effective sample size >400. See ?sma_set_mode for other choices of analysis mode.
```{r}
