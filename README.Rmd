...
When running simulation studies, it is often preferable to work from disk to keep a copy of all the results. By default, if the \code{path} argument is not specified, results are saved in your working directory.
