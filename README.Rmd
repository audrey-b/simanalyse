...
Derive posterior samples for new parameters. To evaluate the performance of the method for those new parameters (e.g. bias), the same transformation must be applied to the true parameter values.
```{r}
