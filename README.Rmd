...
When running simulation studies, it is often preferable to work from disk to keep a copy of all the results. You may save results to file by specifying a path argument in functions, or more simply by specifying the path using options(sims.path =), as follows:
